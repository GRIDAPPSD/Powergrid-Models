...
curl -D- -H "Content-Type: application/xml" --upload-file ./cimxml/IEEE13_OCHRE.xml -X POST %DB_URL%
...
curl -D- -H "Content-Type: application/xml" --upload-file ./cimxml/IEEE9500bal.xml -X POST %DB_URL%
