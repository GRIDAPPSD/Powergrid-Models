#python3 InsertMeasurements.py acep_psil_lines_pq.txt
#python3 InsertMeasurements.py acep_psil_loads.txt
#python3 InsertMeasurements.py acep_psil_machines.txt
#python3 InsertMeasurements.py acep_psil_node_v.txt
#python3 InsertMeasurements.py acep_psil_special.txt
#python3 InsertMeasurements.py acep_psil_xfmr_pq.txt

#python3 InsertMeasurements.py eprij1_lines_pq.txt
#python3 InsertMeasurements.py eprij1_loads.txt
#python3 InsertMeasurements.py eprij1_node_v.txt
#python3 InsertMeasurements.py eprij1_special.txt
#python3 InsertMeasurements.py eprij1_switch_i.txt
#python3 InsertMeasurements.py eprij1_xfmr_pq.txt

#python3 InsertMeasurements.py ieee123_lines_pq.txt
#python3 InsertMeasurements.py ieee123_loads.txt
#python3 InsertMeasurements.py ieee123_node_v.txt
#python3 InsertMeasurements.py ieee123_special.txt
#python3 InsertMeasurements.py ieee123_supplement.txt
#python3 InsertMeasurements.py ieee123_switch_i.txt
#python3 InsertMeasurements.py ieee123_xfmr_pq.txt

#python3 InsertMeasurements.py ieee123pv_loads.txt
#python3 InsertMeasurements.py ieee123pv_lines_pq.txt
#python3 InsertMeasurements.py ieee123pv_node_v.txt
#python3 InsertMeasurements.py ieee123pv_special.txt
...
#python3 InsertMeasurements.py ieee37_node_v.txt
...
#python3 InsertMeasurements.py r2_12_47_2_lines_pq.txt
#python3 InsertMeasurements.py r2_12_47_2_loads.txt
#python3 InsertMeasurements.py r2_12_47_2_node_v.txt
