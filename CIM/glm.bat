...
java CDPSM_to_GLM -l=1 -t=y -e=u -f=60 -v=1 -s=1 -q=y -i=1.0 IEEE8500.XML ieee8500
...
rem java CDPSM_to_GLM -l=0.2 -t=y -e=u -f=60 -v=1 -s=1 -q=y -n=zipload_schedule -z=0.3 -i=0.3 -p=0.4 IEEE8500.XML ieee8500zip
