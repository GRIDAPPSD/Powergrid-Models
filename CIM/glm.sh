...
#java -classpath ".:/Users/mcde601/src/apache-jena-3.1.0/lib/*:/Users/mcde601/src/commons-math3-3.6.1/*" CDPSM_to_GLM -l=0.2 -t=y -e=u -f=60 -v=1 -s=1 -q=y -n=zipload_schedule IEEE8500.XML ieee8500zip
